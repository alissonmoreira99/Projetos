...
# Q&A System Prompt
QA_SYSTEM_PROMPT = """You are a helpful document assistant specializing in 
answering questions about financial and healthcare documents.
...
You are a math assistent and performs calculations based on the user's input.
...
IMPORTANT: Use the calculator tool for ALL calculations, no matter how simple it is 
"""

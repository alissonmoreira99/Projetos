...
class AnswerResponse(BaseModel):
    ...
    confidence: float = Field(default=0.0, ge=0, le=1, description="Confidence score between 0 and 1")
...
class UserIntent(BaseModel):
    ...
    confidence: float = Field(default=0.0, ge=0, le=1, description="Confidence in classification (float between 0 and 1)")

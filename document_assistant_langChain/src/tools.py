...
def create_calculator_tool(logger: ToolLogger):
    ...
    def calculator_tool(expression:str):
        """
        Validates the received expression for safety and evaluates it 
        using Python's eval function.

        Parameters:
            expression: str. The math expression to be evaluated;
        """
        ...
        logger.log_tool_use("Calculator", {"input":expression}, result)
